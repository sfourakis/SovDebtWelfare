include("C:\\Users\\steliosf\\Documents\\GitHub\\SovDebtWelfare\\LongTermDebt_Methods.jl")
include("C:\\Users\\steliosf\\Documents\\GitHub\\SovDebtWelfare\\LongTermDebt_PoliciesMethods.jl")
include("C:\\Users\\steliosf\\Documents\\GitHub\\SovDebtWelfare\\LongTermDebt_WelfareMethods.jl")
...
LTBSpecCE=longTermBondSpec(betaCE,thetaCE,gammaCE,hPen0CE,hPen1CE,RCE,lambdaCE,coupCE,aBoundsCE,aPointsCE,yParamsCE,mParamsCE,simplePenCE,mixFacQCE,mixFacVCE)
...
@time LTBPathsCE,APCheckCE,APDivYCheckCE=simulatePaths(LTBSpecCE,LTBEvalCE,LTBPolCE,0.0,1000,1000)
...
decompResultsCE=decomposeWelfareBeta(LTBSpecCE,LTBEvalCE,welfareResPenUseCCE,welfareResNoPenUseCCE,LTBPathsCE,0.0,1000)
...
#The following are exactly the parameters of Arellano (2008) except for the m shock, which is set to be identical to the one in Chatterjee and Eyigungor (2012)
betaAr=0.95282
thetaAr=0.282
gammaAr=2.0
hPen0Ar=0.969
...
LTBSpecAr=longTermBondSpec(betaAr,thetaAr,gammaAr,hPen0Ar,hPen1Ar,RAr,lambdaAr,coupAr,aBoundsAr,aPointsAr,yParamsCE,mParamsCE,simplePenAr,mixFacQAr,mixFacVAr)
...
decompResultsAr=decomposeWelfareBeta(LTBSpecAr,LTBEvalAr,welfareResPenUseCAr,welfareResNoPenUseCAr,LTBPathsAr,0.0,1000)
...
LTBSpecAG=longTermBondSpec(betaAG,thetaAG,gammaAG,hPen0AG,hPen1AG,RAG,lambdaAG,coupAG,aBoundsAG,aPointsAG,yParamsCE,mParamsCE,simplePenAG,mixFacQAG,mixFacVAG)
...
@time LTBPathsAG,APCheckAG,APDivYCheckAG=simulatePaths(LTBSpecAG,LTBEvalAG,LTBPolAG,0.0,1000,1000)
...
decompResultsAG=decomposeWelfareBeta(LTBSpecAG,LTBEvalAG,welfareResPenUseCAG,welfareResNoPenUseCAG,LTBPathsAG,0.0,1000)
